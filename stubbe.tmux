...
function set_tmux_theme {
  ...
  local tmux_crust="#11111b"
	...
	stb_status_right="#S"
	stb_status_left="#[bg=${tmux_bg},fg=${tmux_fg},bold]#{?client_prefix,,${indicator}}#[bg=${tmux_green},fg=${tmux_bg},bold]#{?client_prefix,${indicator_active},}#[bg=${tmux_fg},fg=${tmux_bg},bold]"
